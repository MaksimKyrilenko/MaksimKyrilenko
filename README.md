...
**FullStack Developer** из России 🇷🇺

*Не просто код — работающие решения для вашего бизнеса*

</div>

**Мой опыт:**
- 🌐 **Веб-разработка:** SPA и сложные веб-сервисы
- 💬 **Telegram:** Mini Apps и чат-боты
- 🤖 **Автоматизация:** Скрипты, парсеры, автоматизация бизнес-процессов

**Философия:** Полный цикл разработки — от интерфейса до серверной части

**Статус:** Открыт для интересных проектов ✅
...
Поддерживаемый и масштабируемый
...
Всегда на связи, быстрая обратная связь
...
Соблюдаю сроки и держу в курсе прогресса
...
Понимаю бизнес-логику, а не просто выполняю ТЗ
